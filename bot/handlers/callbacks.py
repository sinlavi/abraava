from core.platform import CallbackQueryAdapter, InlineKeyboard, InlineKeyboardButton
...
async def handle_callback(bot, callback_query: CallbackQueryAdapter, api_client, user_settings_service,
