...
async def about_command(bot: Client, message: Message):
    about_text = (
        ...
        f"ربات {BOT_NAME} پیشرفته‌ترین ابزار جستجو و دانلود موسیقی است که با اتصال به جدیدترین API ابرآوا (`mm.3rah.ir/mm/api`)، بهترین تجربه را برای شما فراهم می‌کند.\n\n"
        "✨ *ویژگی‌های برجسته:*\n"
