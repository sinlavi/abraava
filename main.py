...
from db import (
    db, init_db,
    insert_artist, insert_collection, insert_track,
    get_artist_db, get_collection_db, get_track_db,
    get_artist_tracks, get_artist_collections, get_collection_tracks,
    get_cache, set_cache,
    local_search,
    insert_user, get_users_db, get_all_users
)
