...
async def check_channel_membership(bot: Client, user_id: int, channel_id: str) -> bool:
    try:
...
async def verify_all_memberships(bot: Client, user_id: int, api_client: APIClient) -> tuple[bool, List[Dict]]:
