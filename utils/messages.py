...
async def edit_message(message, text, reply_markup=None, no_close=False, show_info=False, task_id=None, force_edit=False, show_cancel=False, user_id=None):
...
async def reply_message(message: Message, text: str, reply_markup=None, show_info=False, user_id=None):
    if user_id is None and message.author:
